...
#[derive(Debug)]
pub struct ZustandStoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ZustandStoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ZustandStore processing");
    
    let mut processor = ZustandStoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ZustandStoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ZustandStoreProcessor::new(false);
